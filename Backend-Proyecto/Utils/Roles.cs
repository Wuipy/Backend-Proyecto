...
public static class EstadosLecturaMedidor
{
    ...
    public static readonly string[] Fontanero = ["Registrada", "Con inconsistencia"];
...
public static class EstadosMedidorLectura
{
    public static readonly string[] Todos =
    [
        "Bueno",
...
public static class LecturaMedidorConstantes
{
    public const decimal LimiteConsumoAltoM3 = 50m;
}
